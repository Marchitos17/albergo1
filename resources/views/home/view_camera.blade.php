...
<html lang="en">
   <head>
    <base href="/public"> <!--indica che deve vedere gli include dalla cartella public-->
      @include('home.css')
      ...
      <style>
         .b-example-divider {
            height: 3rem;
            background-color: rgba(164, 44, 44, 0.1);
   ...
   <body class="main-layout">
      ...
      <div class="about">
         <div class="container-fluid">
            <div class="row">
               ...
               <div class="col-md-7">
                  <div class="about_img">
                     <figure><img src="room/{{$data->immagine}}" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="container px-4 py-5">
        ...
        <table class="table table-hover text-nowrap">
          ...
          <tbody>
            <tr>
              <th scope="row">Camera Singola</th>
              <td>18,492</td>
              <td>228</td>
              <td>350</td>
              <td>$4,787.64</td>
            ...
            <th scope="row">Camera Quadrupla</th>
              <td>
                <span class="text-danger">
                  <i class="fas fa-caret-down me-1"></i><span>-48.8%%</span>
                </span>
      ...
      <div class="row row-cols-1 row-cols-md-3 mb-3 mt-5 text-center container-fluid">
         <div class="col">
           <div class="card mb-4 rounded-3 shadow-sm border-primary">
             <div class="card-header py-3 text-bg-primary border-primary">
               <h4 class="my-0 fw-normal">Camera Singola</h4>
             </div>
             <div class="card-body">
               ...
               <ul class="list-unstyled mt-3 mb-4">
                 ...
                 <li>Quantita':
                    <select>
                     ...
                     @if ($data->tipo == 'Camera singola')
                      <a class="read_more" href="{{route('add_prenotazione',$data->id)}}">Prenota Ora</a>
                     @else
                      <button class="read_more btn1" href="#">Prenota Ora</button>
         ...
         <div class="col">
           <div class="card mb-4 rounded-3 shadow-sm border-primary">
             <div class="card-header py-3 text-bg-primary border-primary">
               <h4 class="my-0 fw-normal">Camera Doppia</h4>
             </div>
             <div class="card-body">
               <h1 class="card-title pricing-card-title">
         ...
         <div class="col">
           <div class="card mb-4 rounded-3 shadow-sm border-primary">
             <div class="card-header py-3 text-bg-primary border-primary">
               <h4 class="my-0 fw-normal">Camera Tripla</h4>
             </div>
             <div class="card-body">
               <h1 class="card-title pricing-card-title">
         ...
         <div class="col">
           <div class="card mb-4 rounded-3 shadow-sm border-primary">
             <div class="card-header py-3 text-bg-primary border-primary">
               <h4 class="my-0 fw-normal">Camera Quadrupla</h4>
             </div>
             <div class="card-body">
               <h1 class="card-title pricing-card-title">
                ...
                <small class="text-muted fw-light">/mo</small></h1>
               <ul class="list-unstyled mt-3 mb-4">
                 <li>30 users included</li>
                 <li>15 GB of storage</li>
                 <li>Phone and email support</li>
   ...
   <div class="container px-4 py-5" id="hanging-icons">
      ...
      <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
         ...
         <div>
            <h3 class="fs-2">Commenti persone</h3>
  ...
  <script>
    ...
    btn.addEventListener('click',function(){
      Swal.fire({
        icon: "error",
        title: "ERRORE",
        text: "Le camere selezionate non sono disponibili!",
        footer: '<a href="/">Ritorna alla home.</a>'
      });
    })
  </script>
...
<!--@if (Route::has('login'))
                @auth
                    ...
                    @if ($data->tipo == 'Camera tripla')
                     ...
                     @endif
                     @else
                      <div><span>Effettua il login per poter prenotare le nostre camere</span></div>
                      <a class="read_more" href="{{route('login')}}" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Prenota Ora</a>
                      
                      <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h1 class="modal-title fs-5" id="staticBackdropLabel"><h1 class="fw-bold mb-0 fs-2">Accedi</h1></h1>
