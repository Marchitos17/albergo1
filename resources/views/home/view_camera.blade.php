...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="100">
    ...
    <div class="col-sm-12 section-title text-center mb-5 mt-3">
      <h3>Scegli una delle nostre camere</h3>
    </div>
      ...
      <div class="container">
        <div class="row flex-lg-row flex-column-reverse">
          <div class="col-lg-6 text-center text-lg-start">
            <h3>La camera <span>{{$data->titolo}},<br class="d-none d-lg-block">offre i </span> seguenti servizi.</h3>
            <p><i class="bi bi-patch-check-fill text-success"></i> {{$data->descrizione}}</p>
            <p><i class="bi bi-patch-check-fill text-success"></i> Wifi: {{$data->wifi}} </p>
            <p><i class="bi bi-patch-check-fill text-success"></i> Prezzo: {{$data->prezzo}} </p>
            <p><i class="bi bi-patch-check-fill text-success"></i> Tipo: {{$data->tipo}} </p>
            <a href="#prezzi" class="main-btn mt-4">Esplora</a>
          </div>
          <div class="col-lg-6 mb-4 mb-lg-0 ps-lg-4 text-center">
            <div class="row g-0">
              <div class="col-lg-3 col-md-6 gallery-item">
                <img src="room/{{$data->immagine}}" class="img-fluid w-100" style="height: 273px;" alt="">
...
<section id="prezzi" class="prezzi_wrapper">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 mb-4">
          <div class="card p-4 text-center rounded-3">
            <h5 class="text-decoration-underline mb-4">Camera Singola</h5>
    ...
    <div class="col-lg-3 col-md-6 mb-4" id="#prezzi">
        <div class="card p-4 text-center rounded-3">
            <h5 class="text-decoration-underline mb-4">Camera Doppia</h5>
            <ul class="list-unstyled">
                <li>
                    <p>Flight Ticket(2)</p>
                </li>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card p-4 text-center rounded-3">
            <h5 class="text-decoration-underline mb-4">Camera Tripla</h5>
            <ul class="list-unstyled">
                <li>
                    <p>Flight Ticket(2)</p>
                </li>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card p-4 text-center rounded-3">
            <h5 class="text-decoration-underline mb-4">Camera Quadrupla</h5>
            <ul class="list-unstyled">
                <li>
                    <p>Flight Ticket(2)</p>
                </li>
